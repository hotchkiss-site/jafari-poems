...
# ── lachak — lapis-and-gold corner spandrels (kit/lachak.js) ──
# Static generated tile art in the page corners; the barg draws, the page places.
# NOTE: the script include assumes the jaanam layout (translation/<coll>/ two
# levels below kit/). Bottom pair yields on small screens.
LACHAK_CSS = """
    /* ── lachak — Persian corner spandrels (kit/lachak.js) ── */
    body { position: relative; }
    .lachak-corner {
      position: absolute; width: min(20vw, 210px); height: min(20vw, 210px);
      pointer-events: none; z-index: 0;
    }
    .lachak-tl { top: 0; left: 0; }    .lachak-tr { top: 0; right: 0; }
    .lachak-bl { bottom: 0; left: 0; } .lachak-br { bottom: 0; right: 0; }
    @media (max-width: 900px) {
      .lachak-corner { width: min(17vw, 130px); height: min(17vw, 130px); }
      .lachak-bl, .lachak-br { display: none; }
    }
"""

LACHAK_CORNERS = """<div class="lachak-corner lachak-tl" data-lachak="tl"></div>
<div class="lachak-corner lachak-tr" data-lachak="tr"></div>
<div class="lachak-corner lachak-bl" data-lachak="bl"></div>
<div class="lachak-corner lachak-br" data-lachak="br"></div>"""
...
<script src="../../kit/lachak.js"></script>
</body>
</html>
"""
